<template>
    <n-popover class="!p-0" placement="bottom" trigger="click">
        <template #trigger>
            <hover-container :inverted="theme.header.inverted" class="relative w-40px h-full" tooltip-content="消息通知">
        ...
        >
            <n-tab-pane v-for="(item, index) in tabData" :key="item.key" :name="index">
                <template #tab>
                    <div :class="[isMobile ? 'w-92px' : 'w-120px']" class="flex-x-center items-center">
