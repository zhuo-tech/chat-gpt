<template>
    <div class="h-full">
        <n-card class="h-full shadow-sm rounded-16px" title="权限切换">
            <div class="pb-12px">
                <n-gradient-text :size="20" type="primary">当前用户的权限：{{ auth.userInfo.userRole }}</n-gradient-text>
            </div>
            <n-select
                :options="options"
            ...
            />
            <div class="py-12px">
                <n-gradient-text :size="20" type="primary">权限指令 v-permission</n-gradient-text>
            </div>
            <div>
            ...
            <div class="py-12px">
                <n-gradient-text :size="20" type="primary">权限函数 hasPermission</n-gradient-text>
            </div>
            <n-space>
