<template>
    <n-modal v-model:show="modalVisible" :title="title" class="w-700px" preset="card">
        <n-form ref="formRef" :label-width="80" :model="formModel" :rules="rules" label-placement="left">
            ...
            <n-space :size="24" class="w-full pt-16px" justify="end">
