<template>
    <div class="h-full">
        <n-card class="shadow-sm rounded-16px" title="Icon组件示例">
            ...
            <template #footer>
                <web-site-link class="mt-10px" label="iconify地址：" link="https://icones.js.org/" />
            </template>
        </n-card>
        <n-card class="mt-10px shadow-sm rounded-16px" title="自定义图标示例">
