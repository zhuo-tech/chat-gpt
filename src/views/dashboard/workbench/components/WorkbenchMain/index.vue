    ...
    <n-grid :item-responsive="true" :x-gap="16" :y-gap="16">
        <n-grid-item span="0:24 640:24 1024:16">
            <n-space :size="16" :vertical="true">
                <n-card :bordered="false" class="shadow-sm rounded-16px" size="small" title="项目主要技术栈">
                    <template #header-extra>
                        <a class="text-primary" href="javascript:">更多技术栈</a>
                    </template>
                    <n-grid :item-responsive="true" :x-gap="8" :y-gap="8" cols="m:2 l:3" responsive="screen">
                        <n-grid-item v-for="item in technology" :key="item.id">
                            <technology-card v-bind="item" />
                        </n-grid-item>
                    </n-grid>
                </n-card>
                <n-card :bordered="false" class="shadow-sm rounded-16px" size="small" title="动态">
                    <template #header-extra>
                    ...
                    <n-list>
                        <n-list-item v-for="item in activity" :key="item.id">
                            ...
                            <n-thing :description="item.time" :title="item.content" />
                        </n-list-item>
                    </n-list>
                </n-card>
            </n-space>
        ...
        <n-grid-item span="0:24 640:24 1024:8">
            <n-space :size="16" :vertical="true">
                <n-card :bordered="false" class="shadow-sm rounded-16px" size="small" title="快捷操作">
                    <n-grid :item-responsive="true" :x-gap="8" :y-gap="8" cols="m:2 l:3" responsive="screen">
                ...
                <n-card :bordered="false" class="shadow-sm rounded-16px" size="small" title="创意">
